...
from wtforms.fields import StringField, FloatField, TextAreaField, PasswordField, SelectField, RadioField
...
class DiscountTempletForm(Form):
    ...
    # 计算方式
    type = RadioField(lazy_gettext('By Type'), choices=[], coerce=int)
