...
from . import main
from .. import db
from app.models import Customer, CustomerGrade, User, DiscountTemplet, Category, Brand, \
...
@main.route('/customers/grades')
@main.route('/customers/grades/<int:page>')
...
@main.route('/customers/grades/create', methods=['GET', 'POST'])
def create_grade():
...
@main.route('/customers/grades/<int:id>/edit', methods=['GET', 'POST'])
def edit_grade(id):
...
@main.route('/customers/grades/delete', methods=['POST'])
def delete_grade():
    selected_ids = request.form.getlist('selected[]')
    if not selected_ids or selected_ids is None:
